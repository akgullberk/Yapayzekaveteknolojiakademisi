...
SECRET_KEY = "CclqyGXhAGWtGwHkTH24y5HccDOWuWfRhxZwry3GRXcmDxteUJCFDNAXUAxAt9xF"
ALGORITHM = "HS256"
...
async def login_for_access_token(form_data: Annotated[OAuth2PasswordRequestForm, Depends()], db: dependency):
